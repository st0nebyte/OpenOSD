...
class AudioFormatMapperTest {
    ...
    fun `test DTS formats`() {
        ...
        assertEquals("DTS-ES 8CH Discrete", AudioFormatMapper.formatSoundMode("DTS ES 8CH DSCRT"))
        ...
        assertEquals("DTS 96 ES Matrix", AudioFormatMapper.formatSoundMode("DTS96 ES MTRX"))
        assertEquals("DTS 96/24", AudioFormatMapper.formatSoundMode("DTS96/24"))
